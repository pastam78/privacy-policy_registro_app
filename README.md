...
- **Indirizzo email**: usato per l'autenticazione. Autenticazione che avviene solo ed esclusivamente con account Google.
- **Dati di utilizzo**: Google Firebase raccoglie solo ed esclusivamente orari di appuntamenti e nominativi/nickname. Questi non saranno in nessun caso condivisi e/o condivisibili.
...
2. Vai alla sezione "Sono un Utente" ed accedi all'app.
